...
if(request.getParameter("pinglunren")=="" ||request.getParameter("pinglunren")==null ){}else{sql=sql+" and pinglunren like '%"+request.getParameter("pinglunren")+"%'";}
  ...
  <tr>
    ...
    <td ><a href="pinglun_list.jsp?scid=<%=id %>" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
...
<br>
以上数据共&nbsp<%=i %>&nbsp条,<a style="cursor:pointer" onClick="javascript:window.print();">&nbsp&nbsp<span style='color:blue'>打印本页</span></a>
  </body>
</html>
