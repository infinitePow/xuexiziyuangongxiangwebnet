...
//txixixngdy
    ...
    String url = "xuexiziyuan_list2.jsp?1=1"; 
     String sql =  "select xuexiziyuan.* from xuexiziyuan,yonghuzhuce where xuexiziyuan.tianjiaren=yonghuzhuce.xingming and yonghuzhuce.yonghuming='"+request.getSession().getAttribute("username")+"'";
   // String sql =  "select * from xuexiziyuan where tianjiaren='"select xingming from yonghuzhuce where yonghuming='"+request.getSession().getAttribute("username")+"'"' ";
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="xuexiziyuan_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="xuexiziyuan_list2.jsp?scid=<%=map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a> <a href="xuexiziyuandetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
